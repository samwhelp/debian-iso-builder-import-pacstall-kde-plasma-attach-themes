...
REF_WORK_DIR_PATH="${HOME}/work/debian-iso-builder-import-pacstall-kde-plasma-attach-themes"
...
echo "[Next Step]: cd ~/work/debian-iso-builder-import-pacstall-kde-plasma-attach-themes/iso-profile
"
echo
